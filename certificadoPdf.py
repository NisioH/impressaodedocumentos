...
df = pd.read_excel("dadosCertificado.xlsx", dtype=str)
...
posicoes = {
    "Nome": [(335, 648), (300, 1340)],
    "CPF": [(1370, 648)],
    "DATA": [(500, 988), (1813, 1053)], 
}
...
for i, linha in df.iterrows():
    ...
    imagem_salva = os.path.join(pasta_destino, f"Certificado_{nome_funcionario}.pdf")
